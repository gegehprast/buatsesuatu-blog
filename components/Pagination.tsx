    ...
    return (
        <>
            <Pagination
                ...
                innerClass="flex flex-wrap items-center justify-center w-full mx-auto"
                itemClass="border border-gray-400 rounded pagination-cursor-pointer flex items-center justify-center w-8 h-8 m-1 text-sm text-gray-900 text-xs md:text-sm"
